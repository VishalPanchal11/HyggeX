  ...
  return (
    <div className=" h-[6.5rem] flex items-center justify-between  ">
      ...
      <div className="flex items-center justify-center gap-10 max-md:gap-[10px] max-lg:gap-5 font-inter max-sm:hidden">
        {navList.map((item) => (
          <a className="text-center font-normal text-[18px] text-[#3A3740] leading-[21.78px] cursor-pointer last:w-[8rem] last:h-[3rem] rounded-3xl last:py-[13px] last:bg-gradient-to-b from-[#06286E] to-[#164EC0] last:text-white  ">{item}</a>
        ))}
      </div>
